package com.zouxiao.rabbitmq.noIntegrated.topicMq;
...
/**
 *  订阅模式 Publish/Subscribe   topic类型的Exchange路由
 *
...
public class Consumer2 {
    ...
    //队列名称  -- 多个消费者的队列不能一样
    private static final String QUEUE_NAME="queue_exchange_topic2";
