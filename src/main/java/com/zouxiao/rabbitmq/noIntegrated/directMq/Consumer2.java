package com.zouxiao.rabbitmq.noIntegrated.directMq;
...
/**
 *  订阅模式 Publish/Subscribe   direct类型的Exchange路由
 *
...
public class Consumer2 {
    ...
    //队列名称  -- 多个消费者的队列不能一样
    private static final String QUEUE_NAME="queue_exchange_direct2";
